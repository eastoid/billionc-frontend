<script lang="ts">
    ...
    // /** @type {import('$lib/component/util/toast/toast-stores').SvelteToastOptions} */
    export let item: any
    ...
    /** @param {any} prop */
    function check(prop: any, kind = 'undefined') {
...
>
    <div aria-live="polite" aria-atomic="true" class="_toastMsg" class:pe={item.component}>
        {#if item.component}
